    ...
    return (
        <div className={`bg-indigo-800 text-white p-4 rounded-md shadow-lg transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110 ${task.completed ? 'opacity-50' : ''}`}>
            ...
            <div className="flex justify-center mt-4">
                <button 
                className={`bg-green-500 ${buttonStyle} rounded-md hover:bg-red-400 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110`}  
                onClick={() => deleteTask(task.id)}>
                    Eliminar Tarea
                </button>
                <button 
                className={`bg-blue-500 ${buttonStyle} rounded-md ml-4 hover:bg-red-400 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110`}  
